...
export function EquipoForm({ equipoId, categorias, initialData }: EquipoFormProps) {
    ...
    return (
        <form action={handleSubmit} className="bg-[#111] border border-zinc-800 rounded-2xl p-6 space-y-6 max-w-lg">
            ...
            {/* Barrio */}
            <div className="space-y-2">
                <label htmlFor="barrio" className="block text-sm font-medium text-zinc-400">
            ...
            <div className="space-y-2">
                ...
                <select
                    ...
                    className="w-full px-4 py-3 bg-[#0a0a0a] border border-zinc-800 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#39ff14]/40 focus:border-[#39ff14]/40 transition-all"
                >
            ...
            {/* URL del Logo */}
            <div className="space-y-2">
                <label htmlFor="logoUrl" className="block text-sm font-medium text-zinc-400">
                    URL del escudo
                </label>
                <input
                    id="logoUrl"
