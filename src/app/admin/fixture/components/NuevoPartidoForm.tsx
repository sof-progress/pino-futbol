...
import { crearPartido } from '../../actions/fixture';
import { FormMessage } from '../../components/FormMessage';
import Link from 'next/link';

interface NuevoPartidoFormProps {
    categorias: { id: string; name: string }[];
    equiposPorCategoria: Record<string, { id: string; name: string }[]>;
    canchas: { id: string; name: string }[];
}

// Formulario para crear un nuevo partido con selects dinámicos filtrados por categoría
export function NuevoPartidoForm({ categorias, equiposPorCategoria, canchas }: NuevoPartidoFormProps) {
