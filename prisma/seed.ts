...
async function main() {
    ...
    // 4. Helper function
    const createTeamAndStanding = async (name: string, neighborhood: string, catId: string, stats: any) => {
    ...
    await db.news.create({
        data: {
            title: 'Inscripciones abiertas torneo 2026',
            content: 'La AIFB informa que están abiertas las inscripciones para todas las categorías en la sede social.',
        }
    });
